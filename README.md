...
The catalog models inventory/procurement and workforce specialists, while
runtime availability is always derived from tools that are actually registered.
This combined release includes pharmacy inventory, procurement and approval
tools alongside the Workforce Coordinator for staffing gaps and weekly rosters.
The orchestrator never fabricates a successful delegation: routes whose exact
provider tool is not registered remain visibly unavailable. Widgets display
routing and status while full reasoning and results remain in the host
conversation.
